/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5d820d2b78b5b503cb958328d92758b4)
// Runtime types generated with workerd@1.20260317.1 2025-09-27 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ChannelStateDurableObject";
	}
	interface Env {
		STELLAR_PAY_TO: "GBY77G2AKKMYAW4IVYILYYH5XCPSUL2ERKNQDV4E6QZLYEOUFRCX76IM";
		FACILITATOR_URL: "https://x402.org/facilitator";
		CHANNEL_SERVER_SECRET: string;
		CHANNEL_FACILITATOR_SECRET: string;
		CHANNEL_CONTRACT_ID: string;
		CHANNEL_RPC_URL: string;
		CHANNEL_STATE: DurableObjectNamespace<import("./src/index").ChannelStateDurableObject>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "STELLAR_PAY_TO" | "FACILITATOR_URL" | "CHANNEL_SERVER_SECRET" | "CHANNEL_FACILITATOR_SECRET" | "CHANNEL_CONTRACT_ID" | "CHANNEL_RPC_URL">> {}
}
